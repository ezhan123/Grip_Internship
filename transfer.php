...
$username="root";
$password="";
$con=mysqli_connect($server,$username,$password,"arif");
if(!$con){
...
$sql = "INSERT INTO `transfer`(s_name,s_acc_no,r_name,r_acc_no,amount,date_time) VALUES ('$sender','$s_acc','$receiver','$r_acc','$amount','$dt')";
if ($con->query($sql) === TRUE) {
} else 
{
